...
<div class="container-fluid table-responsive" id="table-container1" style="width:100%">
  <div class="row">
    <div class="col-md admin-sidebar pt-5 pl-0 pr-0">
      ...
      <a class="nav-link rounded-0 link-active mb-1" href="<?php echo base_url(); ?>chat1">Messages</a>
    ...
    <div class="col-md-10 mb-4">
      ...
      <table id="admin" class="table table-striped table-bordered text-center" style="width:100%">
        <thead>
          <tr>
