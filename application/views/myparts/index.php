<div class="container-fluid">
	<div class="row">
		<div class="col-md admin-sidebar pt-5 pl-0 pr-0">
			...
			<a class="nav-link rounded-0 mb-1" href="<?php echo base_url();leave_message?>chat">Messages</a>
			<a class="nav-link rounded-0 mb-1" href="<?php echo base_url(); ?>mycars">Cars</a>
			<a class="nav-link rounded-0 link-active mb-1" href="<?php echo base_url(); ?>myparts">Parts</a>
